...
public class BookingServiceTest extends AbstractTestNGSpringContextTests {
	...
	private static final String EVENT_TEST_NAME = "NewYear";
	...
	private static final String USER_TEST_FIRST_NAME = "Den";
	private static final String USER_TEST_LAST_NAME = "Semenikhin";
	private static final String USER_TEST_EMAIL = "fromrussia@withlove.com";
	private static final LocalDate USER_TEST_BIRTHDAY = LocalDate.of(1985, 3, 15);
	...
	public void initEventTest() {
		...
		event.addAirDateTime(TEST_DATE_TIME, auditorium);
	...
	@Test(dependsOnGroups = { TestConstants.GROUP_EVENT_TEST, TestConstants.GROUP_USER_TEST }, description = "getTicketsPrice()")
	public void getTicketsPriceTest() {
		Set<Long> seats = new HashSet<>(Arrays.asList(2l, 1l));
	...
	@Test(dependsOnGroups = { TestConstants.GROUP_EVENT_TEST, TestConstants.GROUP_USER_TEST }, description = "getPurchasedTicketsForEvent()")
	public void getPurchasedTicketsForEventTest() {
		Ticket firstTestTicket = new Ticket(user, event, TEST_DATE_TIME, 1);
		Ticket secondTestTicket = new Ticket(user, event, TEST_DATE_TIME, 2);
